$(document).ready(function() {
  ...
  $('#fullpage').fullpage({
    anchors: ['aastalopusaade', 'a', 'kokkuvote'],
  ...
  $('[data-fullpagenav]').on('click', function(e) {
    e.preventDefault()
    var target = $(this).data('fullpagenav')
...
// })(function(args) {
  ...
  txtCtx.fillText('L E V E L 2 0 1 7', WIDTH / 2, HEIGHT / 2);
